...
export const PRESETS = [
  ...
  { id: "mbv3", name: "MobileNetV3 Block (+SE, h-swish)", family: "MobileNetV3", composition: ["pwconv","bn","relu","dwconv","bn","se","hswish","pwconv","bn"], strengths: ["Strong mobile accuracy"], drawbacks: ["Extra complexity"], goodSlots: ["stage"] },
  { id: "efficient_mbconv", name: "EfficientNet MBConv + SE (+SiLU)", family: "EfficientNet", composition: ["pwconv","bn","silu","dwconv","bn","se","silu","pwconv","bn"], strengths: ["Accuracy/efficiency balance"], drawbacks: ["Training sensitivity"], goodSlots: ["stage"] },
  { id: "convnext", name: "ConvNeXt Block", family: "ConvNeXt", composition: ["dwconv","ln","pwconv","gelu","pwconv","droppath"], strengths: ["Modern accuracy","Simple"], drawbacks: ["DW perf varies"], goodSlots: ["stage"] },
  ...
  { id: "repvgg", name: "RepVGG Block (train-time branches)", family: "RepVGG", composition: ["conv","bn","relu","conv","bn","relu"], strengths: ["Re-parameterizable to 3×3"], drawbacks: ["Reparam step"], goodSlots: ["stage"] },
  { id: "ghost", name: "GhostNet Ghost Bottleneck", family: "GhostNet", composition: ["pwconv","relu","dwconv","pwconv"], strengths: ["Cheap feature maps"], drawbacks: ["Approximation artifacts"], goodSlots: ["stage"] },
